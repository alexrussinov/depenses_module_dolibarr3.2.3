...
class modDepenses extends DolibarrModules {
	...
	function modDepenses($DB) {
		...
		//compatibilty with 3.1
		$this->config_page_url = array("depensessetup.php@factures_depenses");
		...
		$this->langfiles = array("depenses@factures_depenses");
		...
		$this->menu[$r] = array('fk_menu' => 0, // Put 0 if this is a top menu
				...
				'titre' => $langs->trans("Depenses"), 'mainmenu' => 'depenses',
				'leftmenu' => '1', // Use 1 if you also want to add left menu entries using this descriptor.
				'url' => '/factures_depenses/index.php', 
				//						'langs'=>'mylangfile',	// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
				'position' => 100, 'enabled' => '1', // Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled.
		...
		$this->menu[$r] = array('fk_menu' => 'r=1', // Use r=value where r is index key used for the parent menu entry (higher parent must be a top menu entry)
				'type' => 'left', // This is a Left menu entry
				'titre' => $langs->trans("CreateBill"), 'mainmenu' => 'depenses',
		...
		$this->menu[$r] = array('fk_menu' => 'r=1', // Use r=value where r is index key used for the parent menu entry (higher parent must be a top menu entry)
				'type' => 'left', // This is a Left menu entry
				'titre' => $langs->trans("Unpayed"), 'mainmenu' => 'depenses',
		...
		$this->menu[$r] = array('fk_menu' => 'r=1', // Use r=value where r is index key used for the parent menu entry (higher parent must be a top menu entry)
				'type' => 'left', // This is a Left menu entry
				'titre' => $langs->trans("Payements"), 'mainmenu' => 'depenses',
		...
		// This entry not implemented yet
		/* $this->menu[$r] = array('fk_menu' => 'r=1', // Use r=value where r is index key used for the parent menu entry (higher parent must be a top menu entry)
				'type' => 'left', // This is a Left menu entry
				'titre' => $langs->trans("Raports"), 'mainmenu' => 'depenses',
